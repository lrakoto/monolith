...
The editable scene and render scripts currently live in a separate local worktree;
that handoff records its location, workflow, current baseline, and verification.
