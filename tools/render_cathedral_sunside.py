"""Sunside: the key comes from the left, so the right bank should be lit only near the water."""
...
STILL=Path(QUICK) if QUICK else OUT/'cathedral-sunside-study.png'
random.seed(1707)
...
if not QUICK:bpy.ops.wm.save_as_mainfile(filepath=str(OUT/'cathedral-sunside-study.blend'))
