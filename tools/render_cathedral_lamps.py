"""Lamps: ours are a dotted line of pinpricks where the reference has a few real lanterns."""
...
STILL=Path(QUICK) if QUICK else OUT/'cathedral-lamps-study.png'
random.seed(1707)
...
if not QUICK:bpy.ops.wm.save_as_mainfile(filepath=str(OUT/'cathedral-lamps-study.blend'))
