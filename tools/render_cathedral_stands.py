"""Uneven bank shoulders and connected forest stands around the established camera."""
...
scene.render.image_settings.file_format='PNG';scene.render.filepath=str(OUT/'cathedral-stands-study.png')
...
bpy.ops.wm.save_as_mainfile(filepath=str(OUT/'cathedral-stands-study.blend'))
