"""Layers: the planting stops at 345 and the far silhouettes start at 480, leaving a gap."""
...
STILL=Path(QUICK) if QUICK else OUT/'cathedral-layers-study.png'
random.seed(1707)
...
if not QUICK:bpy.ops.wm.save_as_mainfile(filepath=str(OUT/'cathedral-layers-study.blend'))
