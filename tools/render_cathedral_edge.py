"""Edges: the frame edges want a gradient behind them and a sunstruck tree at the left."""
...
STILL=Path(QUICK) if QUICK else OUT/'cathedral-edge-study.png'
random.seed(1707)
...
sunstruck_material=mat('sunstruck edge canopy',(.075,.115,.053),(.350,.398,.197),1,.2)
...
if not QUICK:bpy.ops.wm.save_as_mainfile(filepath=str(OUT/'cathedral-edge-study.blend'))
