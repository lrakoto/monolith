"""A subdued distant forest backdrop and selective light around the main modeled trunks."""
...
scene.render.image_settings.file_format='PNG';scene.render.filepath=str(OUT/'cathedral-backdrop-study.png')
...
bpy.ops.wm.save_as_mainfile(filepath=str(OUT/'cathedral-backdrop-study.blend'))
