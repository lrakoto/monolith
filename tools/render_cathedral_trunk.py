"""Trunks: the reference columns are near black silhouettes under fine vertical vine streaks."""
...
STILL=Path(QUICK) if QUICK else OUT/'cathedral-trunk-study.png'
random.seed(1707)
...
if not QUICK:bpy.ops.wm.save_as_mainfile(filepath=str(OUT/'cathedral-trunk-study.blend'))
