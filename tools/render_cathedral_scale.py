"""Scale: our crowns read as lumps where the reference has whole trees at that size."""
...
STILL=Path(QUICK) if QUICK else OUT/'cathedral-scale-study.png'
random.seed(1707)
...
soft('near bank opening',(96,-14,88),104000,28,(.83,.89,.73))
...
if not QUICK:bpy.ops.wm.save_as_mainfile(filepath=str(OUT/'cathedral-scale-study.blend'))
