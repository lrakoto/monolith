"""Lighting hierarchy across the established simplified forest composition."""
...
scene.render.image_settings.file_format='PNG';scene.render.filepath=str(OUT/'cathedral-light-study.png')
...
bpy.ops.wm.save_as_mainfile(filepath=str(OUT/'cathedral-light-study.blend'))
