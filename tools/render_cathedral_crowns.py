"""Crowns: the reference canopy is granular at about five percent of a crown, ours is smooth."""
...
STILL=Path(QUICK) if QUICK else OUT/'cathedral-crown-study.png'
random.seed(1707)
...
if not QUICK:bpy.ops.wm.save_as_mainfile(filepath=str(OUT/'cathedral-crown-study.blend'))
