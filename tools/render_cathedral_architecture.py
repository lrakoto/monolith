"""Recessed architecture and subtle stair variation within the established composition."""
...
scene.render.image_settings.file_format='PNG';scene.render.filepath=str(OUT/'cathedral-architecture-study.png')
...
bpy.ops.wm.save_as_mainfile(filepath=str(OUT/'cathedral-architecture-study.blend'))
