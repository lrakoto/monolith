"""Asymmetric simple crown families within the established lighting and scale study."""
...
scene.render.image_settings.file_format='PNG';scene.render.filepath=str(OUT/'cathedral-canopy-study.png')
...
bpy.ops.wm.save_as_mainfile(filepath=str(OUT/'cathedral-canopy-study.blend'))
