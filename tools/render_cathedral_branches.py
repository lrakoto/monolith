"""Small branching shoots break the smooth crown outlines while preserving the composition."""
...
scene.render.image_settings.file_format='PNG';scene.render.filepath=str(OUT/'cathedral-branch-study.png')
...
bpy.ops.wm.save_as_mainfile(filepath=str(OUT/'cathedral-branch-study.blend'))
