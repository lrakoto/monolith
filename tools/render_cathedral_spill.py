"""Spill: a near bank fill reaches the middle distance, and the shore growth reaches the pond."""
...
STILL=Path(QUICK) if QUICK else OUT/'cathedral-spill-study.png'
random.seed(1707)
...
if not QUICK:bpy.ops.wm.save_as_mainfile(filepath=str(OUT/'cathedral-spill-study.blend'))
