"""Rebalance: the key changed what each surface receives, so several of them need resetting."""
...
STILL=Path(QUICK) if QUICK else OUT/'cathedral-rebalance-study.png'
random.seed(1707)
...
stairmat=mat('damp basalt treads',(.0122,.0187,.0158),(.072,.0936,.0792),6,.025,.82)
...
canopy_material=mat('blockout canopy',(.0055,.0133,.0070),(.0329,.0547,.0235),1,.2)
crown_meshes=[]
...
leaf_materials=[]
for j,color in enumerate([(.0101,.0243,.0094),(.0179,.0368,.0109),(.029,.0485,.0156),(.0399,.0595,.0204)]):
...
if not QUICK:bpy.ops.wm.save_as_mainfile(filepath=str(OUT/'cathedral-rebalance-study.blend'))
