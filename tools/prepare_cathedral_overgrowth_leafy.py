...
root=Path(__file__).resolve().parents[1]/'renders';out=root/'cathedral-overgrown-leafy-cloud-v1.blend';assert not out.exists()
bpy.ops.wm.open_mainfile(filepath=str(root/'cathedral-overgrown-connected-cloud-v1.blend'))
s=bpy.context.scene
originals=[bpy.data.objects['fuller right shoreline crown']]*4
meshes={}
