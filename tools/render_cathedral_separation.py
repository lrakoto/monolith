"""Separation: the reference reads as many trees at different heights, ours as one carpet."""
...
STILL=Path(QUICK) if QUICK else OUT/'cathedral-separation-study.png'
random.seed(1707)
...
if not QUICK:bpy.ops.wm.save_as_mainfile(filepath=str(OUT/'cathedral-separation-study.blend'))
