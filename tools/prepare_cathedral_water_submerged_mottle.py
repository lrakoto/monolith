"""Test mottled shallows immediately under the water without moving the scene."""
...
output = root / 'cathedral-water-submerged-mottle-cloud-v1.blend'
...
links.new(mask.outputs['Color'], mix_shelf.inputs[0])
