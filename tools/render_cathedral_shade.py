"""Shade: the upper right bank is lit where the reference keeps it in deep shade."""
...
STILL=Path(QUICK) if QUICK else OUT/'cathedral-shade-study.png'
random.seed(1707)
...
if not QUICK:bpy.ops.wm.save_as_mainfile(filepath=str(OUT/'cathedral-shade-study.blend'))
