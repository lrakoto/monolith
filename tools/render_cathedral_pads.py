"""Pads: the corner cluster covers its cell but merges into one mass instead of reading as pads."""
...
STILL=Path(QUICK) if QUICK else OUT/'cathedral-pads-study.png'
random.seed(1707)
...
if not QUICK:bpy.ops.wm.save_as_mainfile(filepath=str(OUT/'cathedral-pads-study.blend'))
