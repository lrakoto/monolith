"""Wall: the reference runs its plinth much wider and courses it, and shows it between the trees."""
...
STILL=Path(QUICK) if QUICK else OUT/'cathedral-wall-study.png'
random.seed(1707)
...
if not QUICK:bpy.ops.wm.save_as_mainfile(filepath=str(OUT/'cathedral-wall-study.blend'))
