"""Gaps: cell averages match but our median runs high, so the dark between crowns is missing."""
...
STILL=Path(QUICK) if QUICK else OUT/'cathedral-gaps-study.png'
random.seed(1707)
...
if not QUICK:bpy.ops.wm.save_as_mainfile(filepath=str(OUT/'cathedral-gaps-study.blend'))
