"""Gradient: our right bank brightens upward where the reference brightens down to the water."""
...
STILL=Path(QUICK) if QUICK else OUT/'cathedral-gradient-study.png'
random.seed(1707)
...
if not QUICK:bpy.ops.wm.save_as_mainfile(filepath=str(OUT/'cathedral-gradient-study.blend'))
