"""Taper: the trunks were widened to fill the top corners and overshot at mid height."""
...
STILL=Path(QUICK) if QUICK else OUT/'cathedral-taper-study.png'
random.seed(1707)
...
if not QUICK:bpy.ops.wm.save_as_mainfile(filepath=str(OUT/'cathedral-taper-study.blend'))
