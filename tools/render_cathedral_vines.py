"""Vines: the reference drapes its trunks in continuous hanging curtains, ours are speckled."""
...
STILL=Path(QUICK) if QUICK else OUT/'cathedral-vines-study.png'
random.seed(1707)
...
if not QUICK:bpy.ops.wm.save_as_mainfile(filepath=str(OUT/'cathedral-vines-study.blend'))
