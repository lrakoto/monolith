"""Irregular trunk silhouettes and shoreline around the established scale study."""
...
scene.render.image_settings.file_format='PNG';scene.render.filepath=str(OUT/'cathedral-silhouette-study.png')
...
bpy.ops.wm.save_as_mainfile(filepath=str(OUT/'cathedral-silhouette-study.blend'))
