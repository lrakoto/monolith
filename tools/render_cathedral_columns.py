"""Columns: bark went pale chasing streak contrast, and the shore growth reads as rocks."""
...
STILL=Path(QUICK) if QUICK else OUT/'cathedral-columns-study.png'
random.seed(1707)
...
if not QUICK:bpy.ops.wm.save_as_mainfile(filepath=str(OUT/'cathedral-columns-study.blend'))
