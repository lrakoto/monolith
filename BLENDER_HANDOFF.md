...
- Latest full-quality candidate: `renders/cathedral-ascent-lighting-full.png` and `.blend`, built by `tools/render_cathedral_study.py` with the camera, ascent and lighting flags documented below. Latest working shoreline study: `cathedral-shore-natural-study.png` and `.blend` (900px/32samples, original lighting); see the shoreline section below. Reflection experiment `cathedral-pond-reflection-study.*` was not retained. These new outputs stay local/ignored.
